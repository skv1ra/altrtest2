...
export default function Home() {
  ...
  return (
    <main id="top" className="relative min-h-screen overflow-hidden bg-[#040609] text-white">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none fixed inset-0 bg-[radial-gradient(circle_at_78%_8%,rgba(56,189,248,.12),transparent_30%),linear-gradient(180deg,#070a0e,#030405_72%)]"
      />

      <section className="relative z-10 mx-auto grid min-h-screen max-w-[1440px] items-center gap-12 px-5 pb-16 pt-32 lg:grid-cols-[.9fr_1.1fr] lg:px-8">
        <motion.div
          initial={reduced ? false : { opacity: 0, y: 24 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.72 }}
        >
          <p className="text-sm font-medium uppercase tracking-[.14em] text-sky-200/70">{t.eyebrow}</p>
          <h1 className="mt-6 text-balance text-6xl font-medium leading-[.9] tracking-[-.075em] md:text-8xl lg:text-[7rem]">
            {t.heroTitle}
            <br />
            <span className="text-sky-300">{t.heroAccent}</span>
          </h1>
          <p className="mt-8 max-w-2xl text-lg leading-8 text-white/58">{t.heroSubtitle}</p>
          ...
          <p className="mt-7 max-w-xl text-base text-white/38">{t.proof}</p>
        </motion.div>
      ...
      <footer className="relative z-10 mx-auto grid max-w-[1400px] gap-8 px-5 py-12 text-sm text-white/35 md:grid-cols-[1fr_2fr_auto] lg:px-8">
        <div>
          ...
          <p className="mt-5">{t.footer.status}</p>
        </div>
