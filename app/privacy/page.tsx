  ...
  return <LegalPage eyebrow="LEGAL / PRIVACY" title="Privacy Policy" summary="Ця Політика пояснює, які персональні дані Altr збирає, для чого їх використовує, як створюється персональна AI-памʼять і якими правами володіє користувач.">
    ...
    <LegalSection title="2. Які дані ми обробляємо">
      <ul>
        ...
        <li><strong>Переписки й контент:</strong> повідомлення, email, чернетки, вкладення та метадані, які користувач свідомо вводить або підключає до Altr. Ця категорія обробляється лише після окремої згоди або коли це необхідно для явно запитаної функції.</li>
      ...
      <p>У поточній демоверсії профіль, сесія, план і згоди зберігаються локально у браузері користувача. До запуску серверного зберігання ця Політика має бути оновлена фактичним переліком постачальників і місць обробки.</p>
    </LegalSection>
