  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#05080c] text-white">
      ...
      <aside className="dashboard-sidebar fixed inset-y-0 left-0 z-30 hidden w-[272px] border-r border-cyan-100/[.065] p-5 lg:flex lg:flex-col">
        ...
        <div className="mt-auto"><div className="mb-4 rounded-[1.35rem] border border-cyan-100/[.07] bg-white/[.025] p-4"><span className="data-label">{planNames[profile.plan]} plan</span><p className="mt-4 text-sm">Server-backed profile</p><p className="mt-1 text-xs leading-5 text-white/30">Тариф приходить тільки з Lemon webhook.</p></div><button onClick={leave} className="dashboard-nav-item w-full"><LogOut className="h-4 w-4" />Вийти</button></div>
      </aside>
